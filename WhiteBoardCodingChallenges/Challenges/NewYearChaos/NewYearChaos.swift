...
class NewYearChaos: NSObject {
    ...
    class func numberOfBribesToAchieveQueue(_ queue: [Int]) -> Int {
    ...
    class func numberOfBribesToAchieveQueueAlt(_ queue: [Int]) -> Int {
    ...
    class func isValidQueue(_ queue: [Int]) -> Bool {
